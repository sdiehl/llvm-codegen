...
newtype Codegen a = Codegen { runCodegen :: StateT CodegenState (ErrorT String Identity) a }
...
execCodegen vars m = runIdentity $ runErrorT $ (execStateT (runCodegen m) (emptyCodegen { symtab = vars }))
